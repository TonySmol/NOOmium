...
flowchart TB
    subgraph Device["🖥️ ВАШЕ УСТРОЙСТВО"]
        A[Модель ИИ<br>97 МБ Granite-embedding]
...
- **Модель на устройстве**  
  ИИ (97 МБ) работает локально — никто не читает ваши тексты до векторизации.
...
3. Дождитесь модели (~97 МБ, один раз, дальше из кэша)
...
| **AI-модель** | Granite-embedding (97 МБ, ONNX q8, локально) |
